...
OILS_HTML = ggrid(
    ...
    gcard(
        "Масла 4T (четырёхтактные) — минеральное / полусинтетика",
        "арт. 33441/1 · 33442/1 · фасовка 1 л",
        "Льётся в картер, без смешивания с бензином: генераторы, мотоблоки, газонокосилки 4T. Уточните, что написано в инструкции — 2T сюда не подойдёт. Предложите минеральное или полусинтетику по рекомендации производителя техники.",
    ),
    gcard(
...
SOLVENTS_HTML = (
    '<h3 class="subhead">Растворители</h3>'
    + ggrid(
        gcard(
            "Уайт-спирит MIKA",
    ...
    + '<h3 class="subhead">Обезжириватель</h3>'
    + ggrid(
        gcard(
            "Обезжириватель MIKA",
            "арт. 33756/05 · 0,5 л",
    ...
    + '<h3 class="subhead">Огнебиозащита</h3>'
    + ggrid(
        gcard(
...
WHEEL_HTML = ggrid(
    ...
    gcard(
        "Тачка садовая одноколёсная",
        "65 л · арт. 33664236202",
        "Лёгкая садовая для земли, листьев и мелкого мусора на участке. Не обещайте стройку «под бетон» — для этого строительная серия. Уточните, сад это или стройка.",
    ),
)
...
MEMBRANE_HTML = ggrid(
    gcard(
        ...
        "Трёхслойная защита конструкции от влаги и ветра с паропроницаемостью. Разница в площади рулона. Спросите узел кровли/каркаса и не перепутайте стороны укладки.",
    ),
    gcard(
        "Плёнка ветро-влагозащита А премиум Mika 90",
        "35 и 70 м² · арт. 3392135 · 3392170",
        "Ветро-влагозащита типа А. Литраж/метраж рулона под площадь. Уточните пирог стены/кровли.",
    ),
    gcard(
        "Плёнка пароизоляционная В премиум Mika 60",
        "35 и 70 м² · арт. 3392235 · 3392270",
        "Пароизоляция — чтобы пар из помещения не шёл в утеплитель. Разница только в площади. Объясните отличие от ветрозащиты А.",
    ),
    gcard(
        "Плёнки гидро-пароизоляционные С и D премиум",
        "Mika 70 / Mika 95 · 35 и 70 м²",
        "Усиленные плёнки С/D под разные узлы гидро-пароизоляции. Спросите, что пишет проект/инструкция к утеплителю. Метраж — под площадь.",
    ),
)
...
BENCH_HTML = ggrid(
    gcard(
        "Точильные станки BGM-125 / 150 / 200",
        "с лампой и без · арт. 3319125 · 33191125L · 3319150L · 33191200",
        "Два круга для заточки инструмента. Разница в диаметре круга, мощности и наличии лампы. Спросите, что точат: чем больше круг/мощность — тем тяжелее работы. Напомните про очки.",
    ),
    gcard(
...
AUTO_HTML = ggrid(
    gcard(
        "Жидкое мыло 5 л (обычное / перламутровое)",
        "арт. 33000/5 · 33000/5У",
        "Для рук в быту и хознуждах. Разница в варианте состава/перламутра. Предлагайте канистру 5 л, если расход постоянный.",
    ),
    gcard(
        "Бесконтактная мойка EFFECT / Prof / STANDART",
        "фасовки 1 и 5 кг в каждой линейке",
        "Химия для бесконтактной мойки авто. Разница линеек — интенсивность/класс, внутри линейки — только фасовка 1 или 5 кг. Спросите, как часто моют: 1 кг попробовать, 5 кг если регулярно.",
    ),
)
