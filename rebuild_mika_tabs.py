...
<div class="prod-grid">
<article class="prod-card">
  <strong>Вибрационные ВПН — верхний и нижний забор</strong>
  <span class="art">модели: ВПН-10 / 15 / 25 / 40 · арт. 335110В/Н, 335115В/Н, 335125В/Н, 335140В</span>
  <p class="how">Погружные вибрационные насосы для колодца, бочки и неглубокого водозабора. Цифра в названии — длина кабеля (10, 15, 25, 40 м), буква В — верхний забор (чище вода сверху), Н — нижний (выкачать почти до дна). Спросите глубину и нужна ли «чистая сверху» или «выкачать по максимуму» — и берите кабель с запасом.</p>
</article>
<article class="prod-card">
  <strong>Дренажные ДН-750 и НД-750</strong>
  <span class="art">арт. 33528D · 335275D</span>
  <p class="how">Для грязной воды: лужи, подтопления, откачка с частицами (у НД-750 — до 30 мм). Это не питьевой колодец, а «откачать грязь и воду». Уточните, насколько грязная вода и какой расход нужен — предложите ДН или НД по наличию.</p>
</article>
<article class="prod-card">
  <strong>Насосная станция НС-750 · бак 24 л</strong>
  <span class="art">арт. 335324L</span>
  <p class="how">Станция с гидроаккумулятором держит давление в доме или на даче из колодца/ёмкости. Предлагайте, если нужен постоянный напор в кранах, а не разовый полив. Сверьте глубину всасывания и напор — и наличие на складе.</p>
</article>
<article class="prod-card">
  <strong>Скважинные винтовые СН-В 370 / 550 Вт</strong>
  <span class="art">арт. 3354370В · 3354550В</span>
  <p class="how">Винтовые скважинные лучше переносят воду с примесями, чем центробежные. Мощность 370 или 550 Вт — под глубину и нужный напор. Спросите глубину скважины и «песчаная» ли вода — подбирайте с запасом по напору, не впритык.</p>
</article>
<article class="prod-card">
  <strong>Скважинные центробежные СН-Ц 370 / 550 Вт</strong>
  <span class="art">арт. 335430Ц · 335450Ц</span>
  <p class="how">Центробежные дают больше литров в минуту на более чистой воде. Если вода мутная или с песком — честно предложите винтовой СН-В. Уточните диаметр скважины, длину кабеля и напор.</p>
</article>
<article class="prod-card">
  <strong>Поверхностный ПН-800</strong>
  <span class="art">арт. 335543П</span>
  <p class="how">Стоит рядом с источником и тянет воду с небольшой глубины (полив, ёмкость, неглубокий колодец). Спросите глубину всасывания и нужный расход — не обещайте «со скважины 30 метров». Удобен, когда насос не нужно опускать в воду.</p>
</article>
</div>
"""
